...
func (m *BetMapper) MapDomainBetToStorageBet(domainBet domainmodels.Bet) storagemodels.CalcBet {
...
func (m *BetMapper) MapStorageBetToDomainBet(storageBet storagemodels.CalcBet) domainmodels.Bet {
